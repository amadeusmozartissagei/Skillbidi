  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <TopicButton setPrompt={setPrompt} genAI={genAI} setState={setState} setTopicQuestion={setTopicQuestion} setParentOutput={setParentOutput} />
      ...
      <p className="output" ref={outputRef} dangerouslySetInnerHTML={{ __html: parentOutput }}></p>
    </div>
  );
}
